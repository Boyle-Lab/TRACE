...
double ComputeEmission(HMM *phmm, int j, int t, double *O1, double *O2); 
...
void ComputeGammaWithLog(HMM *phmm, int T, double **alpha, double **beta,
        double **gamma);
void ComputeXiWithLog(HMM* phmm, int T, int *O1, double *O2, double *S, double **alpha, double **beta,
        double ***xi);
